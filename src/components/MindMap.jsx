...
function SidebarContent({
  ...
  const handleNextTopic = () => {
    if (currentTopicIndex < topics.length - 1) {
      setIsLoading(true);
      const nextIndex = currentTopicIndex + 1; // Calculate the next index

      // Check if the next index is within bounds
      if (nextIndex < topics.length) {
        const nextTopic = topics[nextIndex];
        const updatedProgress = {
          topicId: nextTopic.id, // Use the next topic's id
          progress: 100, // Assuming you're marking it as complete
        };

        fetch(
          `http://localhost:5000/progress/update-progress/${nextTopic.id}`,
          {
          ...
          .then((response) => {
            if (response.ok) {
              // Progress updated successfully, move to the next topic
              onNext();
            } else {
  ...
  const handlePreviousTopic = () => {
    if (currentTopicIndex > 0) {
      ...
      // Retrieve user's progress for the previous topic from MongoDB
      ...
      fetch(`http://localhost:5000/progress/get-progress`)
        ...
        .then((data) => {
          ...
          if (data && data.overallProgress >= 0) {
            // Progress retrieved successfully, move to the previous topic
            onPrevious();
          } else {
...
const MindMap = () => {
  ...
  useEffect(() => {
    ...
    return () => {
      document.body.style.overflowY = 'auto'; // Restore the default behavior
    };
  }, [showOverlay]);

  return (
    <div className="mind-map" style={bodyStyle}>
      ...
      <ProgressCircles /> 
          ...
          <div className="mind-map">
              ...
              <div className="lminbranch">
                <div className="lbranch">
                  <div className="phpbranch">
                    <div
                      className="phpbox"
                      onClick={() => handleBoxClick(topics[0])}
                    >
                      PHP
                    </div>
                    <div
                      className="javabox"
                      onClick={() => handleBoxClick(topics[1])}
                    >
                      JAVA
                    </div>
                  </div>
                  <div className="rubybranch">
                    <div
                      className="phpbox"
                      onClick={() => handleBoxClick(topics[2])}
                    >
                      RUBY
                    </div>
                    <div
                      className="javabox"
                      onClick={() => handleBoxClick(topics[3])}
                    >
                      .NET
                    </div>
                  </div>
                  <div className="golangbranch">
                    <div
                      className="phpbox"
                      onClick={() => handleBoxClick(topics[4])}
                    >
                      GOLANG
                    </div>
                    <div
                      className="javabox"
                      onClick={() => handleBoxClick(topics[5])}
                    >
                      JAVASCRIPT
                    </div>
                  </div>
              ...
              <div className="rminbranch">
                <div className="rbranch">
                  <div className="pybranch">
                    <div
                      className="pybox"
                      onClick={() => handleBoxClick(topics[6])}
                    >
                      PYTHON
                    </div>
                  </div>
                  <div className="psbranch">
                    <div
                      className="pybox"
                      onClick={() => handleBoxClick(topics[7])}
                    >
                      POWERSHELL
                    </div>
                  </div>
                  <div className="bashbranch">
                    <div
                      className="pybox"
                      onClick={() => handleBoxClick(topics[8])}
                    >
            ...
            <div className="servicesbox">
              ...
              <div className="servicebranchleft">
                <div className="awsbranch">
                  <div
                    className="awsbox"
                    onClick={() => handleBoxClick(topics[9])}
                  >
                    <img src={aws} alt="aws" />
                  </div>
                </div>
                ...
                <div className="digitaloceanbranch">
                  <div
                    className="digitaloceanbox"
                    onClick={() => handleBoxClick(topics[10])}
                  >
                ...
                <div className="ovhbranch">
                  <div
                    className="ovhbox"
                    onClick={() => handleBoxClick(topics[11])}
                  >
                ...
                <div className="oraclebranch">
                  <div
                    className="Oraclebox"
                    onClick={() => handleBoxClick(topics[12])}
                  >
              ...
              <div className="gcloudbranch">
                <div
                  className="gcloudbox"
                  onClick={() => handleBoxClick(topics[13])}
                >
              ...
              <div className="azurebranch">
                <div
                  className="azurebox"
                  onClick={() => handleBoxClick(topics[14])}
                >
              ...
              <div className="tencentbranch">
                <div
                  className="tencentbox"
                  onClick={() => handleBoxClick(topics[15])}
                >
              ...
              <div className="ibmbranch">
                <div
                  className="ibmbox"
                  onClick={() => handleBoxClick(topics[16])}
                >
            ...
            <div className="csmbox">
              ...
              <div className="lcsmbranch">
                <div>
                  <div
                    className="iaasbox"
                    onMouseEnter={handleIaasMouseEnter}
                    onMouseLeave={handleIaasMouseLeave}
                    onClick={() => handleBoxClick(topics[17])}
                  >
                    Infrastructure as a Service (IaaS)
                    {isIaasDescVisible && (
                      <div className="iaasdescbox">
                        IaaS provides virtualized computing resources over the
                        internet. Users can provision and manage virtual
                        machines (VMs), storage, and networking resources.
                        <hr />
                        Example: Amazon Web Services (AWS) Elastic Compute Cloud
                        (EC2) allows users to launch and manage VM instances.
                        Users can choose the operating system, instance type,
                        and storage to create customized virtual machines.
                      </div>
                    )}
                  </div>
                </div>
                ...
                <div className="paasbranch">
                  <div
                    className="paasbox"
                    onMouseEnter={handlePaasMouseEnter}
                    onMouseLeave={handlePaasMouseLeave}
                    onClick={() => handleBoxClick(topics[18])}
                  >
                    Platform as a Service <br /> (PaaS)
                    {isPaasDescVisible && (
                      <div className="paasdescbox">
                        PaaS provides a platform that includes infrastructure,
                        runtime environment, and development tools to build,
                        deploy, and manage applications. Developers focus on
                        coding while the platform handles underlying
                        infrastructure.
                        <hr />
                        Example: Google App Engine is a PaaS offering.
                        Developers can write code in languages like Python,
                        Java, or Node.js and deploy applications without
                        worrying about server provisioning. Google App Engine
              ...
              <div className="rcsmbranch">
                <div className="saasbranch">
                  <div
                    className="saasbox"
                    onMouseEnter={handleSaasMouseEnter}
                    onMouseLeave={handleSaasMouseLeave}
                    onClick={() => handleBoxClick(topics[19])}
                  >
                    Software as a Service (SaaS)
                    {isSaasDescVisible && (
                      <div className="saasdescbox">
                        SaaS delivers software applications over the internet on
                        a subscription basis. Users can access and use software
                        without installation or maintenance efforts.
                        <hr />
                        Example: Salesforce is a widely used SaaS CRM (Customer
                        Relationship Management) platform. Users can log in via
                        a web browser to manage customer relationships, sales,
                        and analytics. They don't need to install any software
                        on their devices.
                      </div>
                    )}
                  </div>
            ...
            <div className="cloudinfrabox">
              ...
              <div className="lcloudinfrabranch">
                <div className="mgsoftbranch">
                  <div
                    className="mgsoftbox"
                    onClick={() => handleBoxClick(topics[20])}
                  >
                    MANAGEMENT SOFTWARE
                    <div className="description">
                      Management software in cloud helps control and optimize
                      digital resources remotely, ensuring efficient use and
                ...
                <div className="deploybranch">
                  <div
                    className="deploybox"
                    onClick={() => handleBoxClick(topics[21])}
                  >
                    DEPLOYMENT SOFTWARE
                    <div className="description">
                      Deployment software simplifies putting apps on the cloud.
                      It automates the process, ensuring apps work well,
                      integrate smoothly, and are easily accessible online.
                    </div>
                  </div>
                </div>
                <div className="hyperbranch">
                  <div
                    className="hyperbox"
                    onClick={() => handleBoxClick(topics[22])}
                  >
                    HYPERVISOR
                    <div className="description">
                      Hypervisor is a firmware or low-level program that acts as
                      a Virtual Machine Manager. It allows to share the single
                      physical instance of cloud resources between several
                      tenants.
                    </div>
                  </div>
                </div>
              ...
              <div className="rcloudinfrabranch">
                <div className="networkbranch">
                  <div
                    className="networkbox"
                    onClick={() => handleBoxClick(topics[23])}
                  >
                    NETWORK
                    <div className="description">
                      Network It is the key component of cloud infrastructure.
                      It allows to connect cloud services over the Internet. It
                      is also possible to deliver network as a utility over the
                ...
                <div className="serverbranch">
                  <div
                    className="serverbox"
                    onClick={() => handleBoxClick(topics[24])}
                  >
                    SERVER
                    <div className="description">
                      The server helps to compute the resource sharing and
                      offers other services such as resource allocation and
                      de-allocation, monitoring the resources, providing
                      security etc.
                    </div>
                  </div>
                </div>
                <div className="storagebranch">
                  <div
                    ...
                    onClick={() => handleBoxClick(topics[25])}
                  >
                    STORAGE
                    <div className="description">
            ...
            <div className="deploymodelbox">
              ...
              <div className="ldeploymodelbranch">
                <div className="publiccloudbranch">
                  <div
                    className="publiccloudbox"
                    onClick={() => handleBoxClick(topics[26])}
                  >
                    PUBLIC CLOUD
                    <div className="description">
                      As the name suggests, this type of cloud deployment model
                      supports all users who want to make use of a computing
                      resource, such as hardware (OS, CPU, memory, storage) or
                      software (application server, database) on a subscription
                      basis.
                    </div>
                  </div>
                </div>
                <div className="privatecloudbranch">
                  <div
                    className="privatecloudbox"
                    onClick={() => handleBoxClick(topics[27])}
                  >
                    PRIVATE CLOUD
                    <div className="description">
                      True to its name, a private cloud is typically
                      infrastructure used by a single organization. Such
                      infrastructure may be managed by the organization itself
                      to support various user groups, or it could be managed by
                      a service provider that takes care of it either on-site or
                      off-site.
                    </div>
                  </div>
                </div>
              ...
              <div className="rdeploymodelbranch">
                <div className="hybridcloudbranch">
                  <div
                    className="hybridcloudbox"
                    onClick={() => handleBoxClick(topics[28])}
                  >
                    HYBRID CLOUD
                    <div className="description">
                      In a hybrid cloud, an organization makes use of
                      interconnected private and public cloud infrastructure.
                      Many organizations make use of this model when they need
                      to scale up their IT infrastructure rapidly, such as when
                      leveraging public clouds to supplement the capacity
                ...
                <div className="communitycloudbranch">
                  <div
                    className="communitycloudbox"
                    onClick={() => handleBoxClick(topics[29])}
                  >
                    COMMUNITY CLOUD
                    <div className="description">
                      This deployment model supports multiple organizations
                      sharing computing resources that are part of a community.
                      It is designed to meet the computing needs of a particular
                      community, such as businesses, government agencies, or
                      research institutions, rather than being available to the
                      general public.
                    </div>
                  </div>
                </div>
            ...
            <div className="endbox">
              ...
              <br />
              <a
                href="https://www.udemy.com/course/basics-of-cloud-computing/"
                target="_blank"
                rel="noopener noreferrer"
              >
                Basics of Cloud Computing on Udemy
              </a>
              <br />
              <a
                href="https://www.simplilearn.com/introduction-to-cloud-computing-basics-skillup"
                target="_blank"
                rel="noopener noreferrer"
              >
                Introduction to Cloud Computing Basics on Simplilearn
              </a>
            </div>
          </div>
